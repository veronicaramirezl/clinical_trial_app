...
1. **Short Background Survey**  
   You will answer questions about demographics, health history, and your general trust in online medical information.

2. **Educational Video**  
   You will watch a brief video explaining a neurosurgical topic.

3. **Post-Video Survey**  
   You will complete a second questionnaire assessing your impression of the presenter, your trust in the information, and how the video influenced your understanding.
...
* **Anonymous participation**  
  We will not collect your name, contact information, or any personally identifying details.

* **Secure data storage**  
  Your responses are stored in a secure system and used only for academic research.

* **Voluntary participation**  
  You may stop at any time without penalty or explanation.
